...
- next, do your design thinking using Figma or similar, starting with mobile
  ...
  [![Figma mobile-first design](images/figma-capy-mobile-first.png)](https://www.figma.com/design/e7ps7dEdfjOQDV2uoTrN01/card-design-h2024?node-id=5-22&t=BJ31sHiJyxfVXlLf-0)
...
- based on the content of your site, create a grid and use semantic html elements to contain your content i.e.
  ...
  - AVOID using div for content
    ...
    [![sketch to wireframe](images/wireframe-html-figma.png)](https://youtu.be/q4s9OmUJQUI?si=doLEGJJjfDwFmesm)
